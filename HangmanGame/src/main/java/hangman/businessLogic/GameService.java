...
public class GameService implements IGameService {
	...
	ApplicationContext ac = new AnnotationConfigApplicationContext(GameRepository.class);

	@Autowired
	IGameRepository gameRepository=ac.getBean("gameRepository",GameRepository.class);
	

	public GameService(IGameRepository gameRepository) {
		this.gameRepository = gameRepository;
		System.out.println("GameService Constructor");
	}
